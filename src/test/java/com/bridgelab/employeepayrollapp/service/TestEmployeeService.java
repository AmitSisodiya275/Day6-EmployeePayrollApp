...
public class TestEmployeeService {
	...
	public void setUp() {
		...
		Employee emp = new Employee(1, "Amit", "Male", 25000.0, LocalDate.now(), "this is note", "this pic ",
				department);
		Employee emp1 = new Employee(2, "Shreya", "Female", 35000, LocalDate.now(), "notes", "pic", department);
